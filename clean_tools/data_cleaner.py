...
class cleaner:
    '''    
        property:
            * checker: output dfs that summarize duplicated labels, lengthy classes
            * standard_process: cleaning data using all processes
        cleaning method:
...
if __name__ == '__main__':
    ...
    # check = checker(res).check_duplicates
    #%% ck
